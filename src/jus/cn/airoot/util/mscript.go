...
func (m *MScript) ReadFromString(js string) {
	...
	//00装入关键字
	keyWord := [...]string{"public", "private", "super", "var", "let", "function", "func", "if", "else", "switch", "case", "while", "for", "in", "do", "static", "import", "new", "include", "return", "class", "extends", "implements", "interface", "this", "@this", "@res", "set", "get", "try", "catch", "finally", "from"}
