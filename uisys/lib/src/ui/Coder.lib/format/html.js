		...
		if(ch == '!' || ch == '.' || ch == '\r' || ch == '\n' || ch == ' ' || ch == '\t' || ch == '{' || ch == '}' || ch == '[' || ch == ']' || ch == '(' || ch == ')' || ch == ';' || ch == ':' || ch == ',' || ch == '?' || ch == '>' || ch == '=' || ch == '<' || ch == '&' || ch == '|' || ch == '%' || ch == '+' || ch == '-' || ch == '*' || ch == '/' || ch == '#' ){
			...
			if(ch == '!' || ch == '.' || ch == '\r' || ch == '\n' || ch == '{' || ch == '}' || ch == '(' || ch == ')' || ch == '[' || ch == ']' || ch == ';' || ch == ':' || ch == ',' || ch == '?' || ch == '>' || ch == '=' || ch == '<' || ch == '&' || ch == '|' || ch == '%' || ch == ' ' || ch == '\t' || ch == '+' || ch == '-' || ch == '*' || ch == '/' || ch == '#'){
				if(ch == '\n'){
					...
					buf += "<span islock='true' type='TAB' style='color: transparent;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>"
					
				}else if(ch == ' '){
					buf += "<span islock='true' type='SPACE' style='color: transparent;'>&nbsp;</span>"
				}else{
					if(ch == '\r'){
						continue;
					}
...
function readString(){
	...
	return "<span class='word' style='color:#00aa00'>" + sb.replace("\r\n", t + " + " + t) + "</span>";
}
